      ...
      <div class="container-fluid p-0">
        ...
        <section class="resume-section p-2 p-lg-5 " id="about">
            ...
            <div class="my-auto" style="">
              ...
              <div class="mb-0 p-0" style="margin-left:5px;">
                ...
                <div class="input-group">
                  <input type="text" class="form-control col-lg-12" placeholder="search user...">
                  <button type="submit" name="submit" style="border-radius:3px;"><i class="fa fa-search"></i></button>
                </div>
              </form>
            </div> <br>
            @foreach ($searchusers as $searchuser)
              <a href="/search/{{$searchuser->email}}"><h5 class="mb-0">{{strtoupper($searchuser->fname)}}
                <span class="text-primary">{{strtoupper($searchuser->lname)}}</span>
              </h5></a>
            @endforeach <br>
          ...
          <div class="col-lg-6">
            ...
            @endforeach
            <a href="/seemore" class="btn  btn-xs invitepic" id="seemore">Se more</a>
