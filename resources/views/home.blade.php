        ...
        <section class="resume-section p-2 p-lg-5 " id="about">
          ...
          <div class="row">
            ...
            @foreach ($friends as $friend)
              <div class="col-lg-3 card card-block bg-faded" id="card">
                <div class="">
                  <a href="/profile/{{$friend->invited_by}}" class="subheading mb-5" style="">{{$friend->invited_by}}</a>
                </div>
                <div class="car-body">
                  <a href="image/{{$friend->image}}">
                    <img id="homeimg" src="{{asset('image/'. $friend->image)}}" alt="">
                  </a>
                </div>
